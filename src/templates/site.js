...
function homepage({ essays }) {
  ...
  const body = `  <div class="stage">
    ...
    <div class="stage__inner">
      ...
      <div class="about">
        <p>Technical Chief of Staff at <a href="https://www.rainmaker.com/" target="_blank" rel="noopener noreferrer">Rainmaker</a>.<span class="about-extra"> I enjoy solo mountaineering, military history, philosophy, and writing essays on civilization and technology. All opinions are my own.</span></p>
